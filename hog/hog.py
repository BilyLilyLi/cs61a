...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal) and (score1 < goal):
        if current_player == 0:
            p0_stra = strategy0(score0, score1)
            current_turn_p0_score = take_turn(p0_stra, score1, dice)
            score0 = score0 + current_turn_p0_score
            if feral_hogs:
                if abs(p0_stra - last_turn_p0_score) == 2:
                    score0 += 3
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            last_turn_p0_score = current_turn_p0_score
            current_player = other(current_player)
        else:
            p1_stra = strategy1(score1, score0)
            current_turn_p1_score = take_turn(p1_stra, score0, dice)
            score1 = score1 + current_turn_p1_score
            if feral_hogs:
                if abs(p1_stra - last_turn_p1_score) == 2:
                    score1 += 3
            if is_swap(score1, score0):
                score0, score1 = score1, score0
            last_turn_p1_score = current_turn_p1_score
            current_player = other(current_player)
    # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say_highest(score0, score1):
        ...
        the_running_high = running_high
        if who == 1:
            score_diff = score1 - last_turn_score
        else:
            score_diff = score0 - last_turn_score
        if score_diff > 0 and score_diff > the_running_high:
            print(score_diff, "point(s)! That's the biggest gain yet for Player", who)
            the_running_high = score_diff
        if who == 1:
            last_turn_score = score1
        else:
            last_turn_score = score0
        return announce_highest(who, last_turn_score, the_running_high)
    return say_highest
    # END PROBLEM 7
